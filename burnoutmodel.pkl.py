...
Original file is located at
    https://colab.research.google.com/drive/1dflBY566hSDxN6uVFsxnQGjm88Yf5J-z
"""
...
# Step 3: Encode categorical features (example mapping)
study_map = {"0-2 hrs":0, "3-5 hrs":1, "6-8 hrs":2, "9+ hrs":3}
sleep_map = {"<5 hrs":0, "5-6 hrs":1, "7-8 hrs":2, "9-10 hrs":3}
stress_map = {"Low":0, "Moderate":1, "High":2}

data["study_hours"] = data["study_hours"].map(study_map)
data["sleep_hours"] = data["sleep_hours"].map(sleep_map)
data["stress"] = data["stress"].map(stress_map)

# Step 4: Split features and target
X = data[["study_hours", "sleep_hours", "stress", "cgpa", "attendance"]]
y = data["burnout_level"]  # 0=Low, 1=Medium, 2=High
